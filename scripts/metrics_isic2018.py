...
pretrained_weights_path = os.path.join(project_root, "weights/best_model_isic2018.pth")
...
plt.savefig(os.path.join(plots_dir, 'sample_predictions_with_metrics_isic2018.png'), dpi=300, bbox_inches='tight')
plt.show()
