...
if __name__ == "__main__":
    ...
    best_loss = float("inf")
    best_model_path = os.path.join(weights_dir, "best_model_isic2018.pth")
    ...
    final_model_path = os.path.join(weights_dir, "model_isic2018.pth")
    ...
    plt.savefig(os.path.join(plots_dir, 'sample_predictions_grid_isic2018.png'))
    plt.show()
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(os.path.join(plots_dir, 'loss_curve_isic2018.png'))
    plt.show()
