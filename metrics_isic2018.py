...
pretrained_weights_path = "weights/best_model_isic2018_5.pth"  # Update this path if needed
...
plt.tight_layout()
plt.savefig('plots/sample_predictions_with_metrics_isic2018_5.png', dpi=300, bbox_inches='tight')
plt.show()
