...
pretrained_weights_path = "weights/best_model_isic2018_4.pth"  # Update this path if needed
...
# 
# This notebook loads a pretrained MSGU-Net model and evaluates it on the ISIC2018 test dataset to calculate:
...
plt.tight_layout()
plt.savefig('plots/sample_predictions_with_metrics_isic2018_4.png', dpi=300, bbox_inches='tight')
plt.show()
