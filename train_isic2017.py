...
best_loss = float("inf")
best_model_path = "weights/best_model_isic2017_3.pth"
...
torch.save(model.state_dict(), "weights/model_isic2017_3.pth")
...
plt.tight_layout()
plt.savefig('plots/sample_predictions_grid_isic2017_3.png')
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('plots/loss_curve_isic2017_3.png')
plt.show()
